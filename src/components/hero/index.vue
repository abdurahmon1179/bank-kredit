...
@media(max-width:1070px) {
  ...
  .currency-menu__title>p {
    font-size: 14px !important;
  }

  .currency-menu__date>p {
    font-size: 14px !important;
  }
